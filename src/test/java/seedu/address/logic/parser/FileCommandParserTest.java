...
public class FileCommandParserTest {
    ...
    public void parse_validArgs_returnsFileCommand() {
        assertParseSuccess(parser, "1", new FileCommand(INDEX_FIRST_PERSON));
    }

    @Test
    public void parse_invalidArgs_throwsParseException() {
        assertParseFailure(parser, "a", String.format(MESSAGE_INVALID_COMMAND_FORMAT, FileCommand.MESSAGE_USAGE));
    }
}

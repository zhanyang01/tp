...
public class EditPersonDescriptorBuilder {
    ...
    /**
     * Sets the {@code preferredContact} of the {@code EditPersonDescriptor} that we
     * are building.
     */
    public EditPersonDescriptorBuilder withPreferredContact(String preferredContact) {
        descriptor.setPreferredContact(new PreferredContact(preferredContact));
        return this;
    }

    /**
     * Sets the {@code preferredMeetingRegion} of the {@code EditPersonDescriptor}
     * that we are building.
     */
